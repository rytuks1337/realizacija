...
// Update pogrupis
async function updatePogrupiai({ pavadinimas, svoris, amzius_k, lytis, varzybos_ID }) {
  const client = await pool.connect();
  try {
    const result = await client.query(
      'UPDATE Pogrupis (pavadinimas, svoris, amzius_k, lytis, ranka, varzybos_ID) VALUES ($1, $2, $3, $4, $5, $6 ) RETURNING',
      [pavadinimas, svoris, amzius_k, lytis, ranka, varzybos_ID]
    );
